...
const uri = "mongodb+srv://gowtham:none@cluster0.jlft8pp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
const rpName = 'SimpleWebAuthn Example';
const rpID = 'infisign.net';
const origin = `https://yubikey.${rpID}`;
